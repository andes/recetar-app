...
| `profile/organizations` | `OrganizationsSettingsComponent` | Built | `ProfileModule` + routing | `CanvasComponent`, `SidebarService`, `OrganizationsService`, `OrganizationsDialogComponent`, `SharedModule` |
