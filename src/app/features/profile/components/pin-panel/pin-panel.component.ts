...
@Component({
    ...
    styleUrls: ['./pin-panel.component.sass'],
    standalone: true,
    imports: [
        CommonModule,
        ReactiveFormsModule,
...
export class PinPanelComponent implements OnInit, OnDestroy {
    ...
    get isFormOpen(): boolean {
        return this.showSetupForm || this.showChangeForm || this.showDisableForm;
    }
